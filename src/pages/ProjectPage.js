...
export const ProjectPage = () => {
  ...
  return (
    <MainLayout>
      <div className="flex items-center justify-end bg-[#fff] px-[20px] py-[10px] ml-[270px] rounded-[8px] mr-[20px] mb-[20px] mt-[100px] border dark:border-[#202020] dark:bg-[#0D0D0D] dark:text-white">
        {projects.length > 0 && (
      ...
      <main className="main mt-0">
        ...
        {projects.length > 0 && (
          <>
            <div className="flex mt-[20px] text-[14px] items-center bar-project mb-[7px] min-h-[50px] rounded-[8px] border  px-[15px] py-[10px] bg-[#FAFBFC] dark:bg-black dark:border-[#202020]">
              ...
              <div className="bar-project-status flex-1 mr-[20px]">
                Участники
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="bar-project-date w-[42px] mr-[10px] text-center">
                        <button className="flex group items-center border justify-center w-[42px] h-[42px] bg-[#FAFBFC] hover:bg-[#1B4FE2] dark:border-[#202020] dark:bg-[#0D0D0D] mx-auto  rounded-[8px]">
                          <FaRegEdit
